...
async function register(req, res) {
 ...
 if (!email || !password || !firstname || !lastname || !username) {
    return res.status(StatusCodes.BAD_REQUEST).json({ msg: "please provide all require fields"})
 }
try{
...
const hashedPassword = await bcrypt.hash(password, salt)
    ...
    await dbConnection.query("INSERT INTO users (username, firstname, lastname, email, password) VALUES (?,?,?,?,?) ", [username, firstname,
